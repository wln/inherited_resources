...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<responders>, [">= 0.4.2"])
      s.add_runtime_dependency(%q<has_scope>, [">= 0.4"])
    else
      s.add_dependency(%q<responders>, [">= 0.4.2"])
      s.add_dependency(%q<has_scope>, [">= 0.4"])
    end
  else
    s.add_dependency(%q<responders>, [">= 0.4.2"])
    s.add_dependency(%q<has_scope>, [">= 0.4"])
